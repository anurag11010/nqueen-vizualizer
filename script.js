...
const queen = '<i class="fas fa-chess-queen" style="color:#0000ff"></i>';

let n, speed, temSpeed, q, Board = 0;

// Creating array for all the possible arrangements of the N-Queen
//considering values will be upto 9
...
class Queen {
    ...
    isValid = async (board, r, col, n) => {
        ...
        for (let i = r - 1; i >= 0; --i) {
            ...
            column.style.backgroundColor = "#FFD580";
            await q.delay();
        }
        ...
        for (let j = 0; j < n; ++j) {
            ...
            for (let k = 0; k < n; ++k)
                (j + k) & 1
                    ...
                    : (row.getElementsByTagName("td")[k].style.backgroundColor = "#000000");
        }
    }
    ...
    for (let k = 0; k < array[n]; ++k) {
        ...
        for (let i = 0; i < n; ++i) {
            ...
            for (let j = 0; j < n; ++j) {
                ...
                (i + j) & 1
                    ? (col.style.backgroundColor = "#FFD580")
                    : (col.style.backgroundColor = "#FFD580");
                col.innerHTML = "-";
